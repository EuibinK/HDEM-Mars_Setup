...
OPTIONS:
    ...
    --image <1|2|3> Download orthoimage for image1, image2, or both (3) (default: none)
...
EXAMPLES:
    ...
    $(basename "$0") DTEEC_015947_1370_051036_1370_A01.tif --image 3 
...
while [[ $# -gt 0 ]]; do
    ...
    --image)
        if [[ "$2" != "1" && "$2" != "2" && "$2" != "3" ]]; then
            echo "Error: --image must be 1, 2, or 3"
            exit 1
        fi
        DOWNLOAD_IMAGE="$2"
        shift 2
